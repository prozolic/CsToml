...
public partial class TomlDocument
{
    ...
    public TomlValue? Find(ReadOnlySpan<ByteArray> keys)
        => table.Find(keys);
    ...
    public TomlValue? Find(ReadOnlySpan<byte> tableHeader, ReadOnlySpan<byte> key, bool isTableHeaderAsDottedKeys = false, bool isDottedKeys = false)
    {
    ...
    public TomlValue? Find(ReadOnlySpan<byte> tableHeader, ReadOnlySpan<ByteArray> key, bool isTableHeaderAsDottedKeys = false)
    {
        var tableNode = isTableHeaderAsDottedKeys ? table.FindNodeAsDottedKey(table.RootNode, tableHeader) : table.FindNode(table.RootNode, tableHeader);
        if (tableNode.NodeCount == 0 && !tableNode.IsTableHeaderDefinitionPosition) return default;
    ...
    public TomlValue? Find(ReadOnlySpan<ByteArray> tableHeader, ReadOnlySpan<byte> key, bool isDottedKeys = false)
    {
    ...
    public TomlValue? Find(ReadOnlySpan<ByteArray> tableHeader, ReadOnlySpan<ByteArray> key)
    {
        var tableNode = table.FindNode(table.RootNode, tableHeader);
        if (tableNode.NodeCount == 0 && !tableNode.IsTableHeaderDefinitionPosition) return default;
    ...
    public TomlValue? Find(ReadOnlySpan<char> tableHeader, ReadOnlySpan<char> key, bool isTableHeaderAsDottedKeys = false, bool isDottedKeys = false)
    {
    ...
    public TomlValue? Find(ReadOnlySpan<byte> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<byte> key, bool isTableHeaderAsDottedKeys = false, bool isDottedKeys = false)
    {
        ...
        if (arrayOfTablesValue is TomlArray csTomlArrayOfTables)
        {
            if (csTomlArrayOfTables!.Count == 0 || csTomlArrayOfTables!.Count <= arrayIndex)
                return default;

            // find Value
            var t = (csTomlArrayOfTables[arrayIndex]! as TomlTable)!;
    ...
    public TomlValue? Find(ReadOnlySpan<byte> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<ByteArray> key, bool isTableHeaderAsDottedKeys = false)
    {
        // find Array Of Tables
        var arrayOfTablesValue = isTableHeaderAsDottedKeys ?
            table.FindArrayOfTableOrValueAsDotted(arrayOfTableHeader) :
        ...
        if (arrayOfTablesValue is TomlArray csTomlArrayOfTables)
        {
            ...
            // find Value
            var value = (csTomlArrayOfTables[arrayIndex]! as TomlTable)!.FindArrayOfTablesOrValue(key);
            return value.HasValue ? value : default;
    ...
    public TomlValue? Find(ReadOnlySpan<ByteArray> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<byte> key, bool isDottedKeys = false)
    {
        // find Array Of Tables
    ...
    public TomlValue? Find(ReadOnlySpan<ByteArray> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<ByteArray> key)
    {
        // find Array Of Tables
        var arrayOfTablesValue = table.FindArrayOfTablesOrValue(arrayOfTableHeader);
        if (arrayOfTablesValue is TomlArray csTomlArrayOfTables)
    ...
    public TomlValue? Find(ReadOnlySpan<char> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<char> key, bool isDottedKeys = false)
    {
        // buffer size to 3 times worst-case (UTF16 -> UTF8)
    ...
    public bool TryFind(ReadOnlySpan<ByteArray> key, out TomlValue? value)
    {
    ...
    public bool TryFind(ReadOnlySpan<byte> tableHeaderKey, ReadOnlySpan<byte> key, out TomlValue? value, bool isTableHeaderAsDottedKeys = false, bool isDottedKeys = false)
    {
        value = Find(tableHeaderKey, key, isTableHeaderAsDottedKeys, isDottedKeys);
        return value?.HasValue ?? false;
    }

    public bool TryFind(ReadOnlySpan<byte> tableHeaderKey, ReadOnlySpan<ByteArray> key, out TomlValue? value, bool isTableHeaderAsDottedKeys = false)
    {
    ...
    public bool TryFind(ReadOnlySpan<ByteArray> tableHeader, ReadOnlySpan<byte> key, out TomlValue? value, bool isDottedKeys = false)
    {
    ...
    public bool TryFind(ReadOnlySpan<ByteArray> tableHeader, ReadOnlySpan<ByteArray> key, out TomlValue? value)
    {
    ...
    public bool TryFind(ReadOnlySpan<char> tableHeader, ReadOnlySpan<char> key, out TomlValue? value, bool isTableHeaderAsDottedKeys = false, bool isDottedKeys = false)
    {
        // buffer size to 3 times worst-case (UTF16 -> UTF8)
        var maxBufferSize = (tableHeader.Length + key.Length + 1) * 3;
        if (maxBufferSize < 1024)
    ...
    public bool TryFind(ReadOnlySpan<byte> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<byte> key, out TomlValue? value, bool isTableHeaderAsDottedKeys = false, bool isDottedKeys = false)
    {
    ...
    public bool TryFind(ReadOnlySpan<byte> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<ByteArray> key, out TomlValue? value, bool isTableHeaderAsDottedKeys = false)
    {
    ...
    public bool TryFind(ReadOnlySpan<ByteArray> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<byte> key, out TomlValue? value, bool isDottedKeys = false)
    {
    ...
    public bool TryFind(ReadOnlySpan<ByteArray> arrayOfTableHeader, int arrayIndex, ReadOnlySpan<ByteArray> key, out TomlValue? value)
    {
